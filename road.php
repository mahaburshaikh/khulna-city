                    ...
                    <!-- Wrapper for slides -->
                      <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="images/rd1.jpg" alt="Chania" height="50" width="1000">
                            
                        </div>

                        <div class="item">
                            <img src="images/rd2.JPG" alt="Chania" height="50" width="1000">
                        ...
                        <div class="item">
                            <img src="images/rd3.jpg" alt="Flower" height="50" width="1000">
...
<div class="middle">
                            ...
                            $statement = $db->prepare("SELECT * FROM road");
                            $statement->execute();
...
<a href="road_details.php?id=<?php echo $row['id']; ?>"><?php echo $row['name'];?></a><br>
<?php
                            }
?>
</div>                    
