                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="index.php">KHULNA
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="restaurant_image/1slider1.jpg" alt="Chania" height="40" width="900">
                            
                        </div>

                        <div class="item">
                            <img src="restaurant_image/1slider2.jpg" alt="Chania" height="40" width="900">
                            <
                        </div>

                        <div class="item">
                            <img src="restaurant_image/1slider3.jpg" alt="Flower" height="40" width="900">
                            
                        </div>

                        <div class="item">
                            <img src="restaurant_image/1slider4.jpg" alt="Flower" height="40" width="900">
...
<a href="restaurant_details.php?id=<?php echo $row['id']; ?>"><?php echo $row['resraurant_name'];?></a><br>
<?php
                            }
?>
</div>
                            <div class="clear"></div>
                                ...
                                <div class="web">
                                    ...
                                    <div class="single_demo_post">
                                        <img src="images/res4.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
                                        <img src="images/1slider1.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
                                        <img src="images/1slider2.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
                                        <img src="images/1slider3.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
                                        <img src="images/1slider4.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
