...
<di style="text-align: center"><h1>CASTLE SALAM</h1></di>
<div class="photo">
    <img src="restaurant_image/<?php echo $row['restaurant_image']; ?>" style="width: 800px; height: 400px;"><br>
</div>
   <div class="cription"> 
 <?php
echo $row['resraurant_name']."<br>";
echo $row['palace']."<br>";
     ...
     <div class="clear"></div>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="single_demo_post">
                                        <img src="restaurant_image/cas1.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
                                        <img src="restaurant_image/cas2.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
                                        <img src="restaurant_image/cas4.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
                                        <img src="restaurant_image/cas4.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
                                        <img src="restaurant_image/cas5.jpg" class="img-thumbnail" style="width: 25%; height: 150px"/>
