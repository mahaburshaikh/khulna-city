...
if (isset($_POST['form1'])) {
    ...
    try {
        ...
        $up_filename = $_FILES["place_image"]["name"];
        ...
        move_uploaded_file($_FILES["place_image"]["tmp_name"], "../place_image/" . $f1);

        $statement = $db->prepare("INSERT INTO beautiful_place(name,description,place_image,place) VALUES(?,?, ?, ?)");
...
<form action="" method="post" enctype="multipart/form-data">
    <table class="tbl1">
        ...
        <tr><td>Image</td></tr>
        <tr><td><input type="file" name="place_image"></td></tr>
