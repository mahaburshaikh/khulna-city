...
if (isset($_POST['form1'])) {
    ...
    try {
        ...
        $up_filename = $_FILES["market_image"]["name"];
        ...
        move_uploaded_file($_FILES["market_image"]["tmp_name"], "../market_image/" . $f1);

        $statement = $db->prepare("INSERT INTO market(name,description,place_image,place) VALUES(?,?, ?, ?)");
...
<form action="" method="post" enctype="multipart/form-data">
    <table class="tbl1">
        ...
        <tr><td>Image</td></tr>
        <tr><td><input type="file" name="market_image"></td></tr>
