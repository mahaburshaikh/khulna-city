                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="images/parkslide.jpg" alt="Chania" height="40" width="900">
                            
                        </div>

                        <div class="item">
                            <img src="images/parkslide1.jpg" alt="Chania" height="40" width="900">
                           
                        </div>

                        <div class="item">0
                            <img src="images/parkslide2.jpg" alt="Flower" height="40" width="900">
                            
                        </div>

                        <div class="item">
                            <img src="images/parlslide3.jpg" alt="Flower" height="40" width="900">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="site-content">
                            ...
                            $statement = $db->prepare("SELECT * FROM park");
                            $statement->execute();
...
<a href="park_details.php?id=<?php echo $row['id']; ?>"><?php echo $row['name'];?></a><br>
<?php
                            }
?>
                            </div>
