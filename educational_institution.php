                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="park_image/">Park</a></li>
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="images/edu1.jpg" alt="Chania" height="50" width="1000">
                            
                        </div>

                        <div class="item">
                            <img src="images/edu2.jpg" alt="Chania" height="50" width="1000">
                            
                        </div>

                        <div class="item">
                            <img src="images/du3.jpg" alt="Flower" height="50" width="1000">
                            
                        </div>

                        <div class="item">
                            <img src="images/edu4.jpg" alt="Flower" height="50" width="1000">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="site-content">
                            ...
                            $statement = $db->prepare("SELECT * FROM education");
                            $statement->execute();
...
<a href="educational_institution_details.php?id=<?php echo $row['id']; ?>"><?php echo $row['name'];?></a><br>
<?php
                            }
?>
                            </div>           
